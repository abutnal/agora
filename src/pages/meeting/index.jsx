    ...
    return (
      <div className="wrapper meeting">
        ...
        <div className="ag-footer">
          <a className="ag-href" href="https://fansplan.com/">
            <span>Powered By FansPlan</span>
          </a>
          {/* <span>Talk to Support: 1234567890</span> */}
        </div>
         {/* <div className="ag-footer">
          <a className="ag-href" href="https://fansplan.com/">
            <span>FansPlan</span>
          ...
          <div>
            <span>A Subscription Based
Social Media Networking Site for Real Influencers & Real People</span>
            <span className="ag-contact"> info@fansplan.com</span>
          </div>
        </div> */}
      </div>
    );
